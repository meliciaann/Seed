...
Namespace DataSet2TableAdapters
    ...
    Partial Public Class OrdersTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [orders] WHERE (([OrderID] = @Original_OrderID) AND ((@IsNull_Invoice"& _ 
                "ID = 1 AND [InvoiceID] IS NULL) OR ([InvoiceID] = @Original_InvoiceID)) AND ([Cu"& _ 
                "stomerID] = @Original_CustomerID) AND ((@IsNull_Project = 1 AND [Project] IS NUL"& _ 
                "L) OR ([Project] = @Original_Project)) AND ((@IsNull_Acres = 1 AND [Acres] IS NU"& _ 
                "LL) OR ([Acres] = @Original_Acres)) AND ((@IsNull_OrderTotal = 1 AND [OrderTotal"& _ 
                "] IS NULL) OR ([OrderTotal] = @Original_OrderTotal)) AND ((@IsNull_OrderDate = 1"& _ 
                " AND [OrderDate] IS NULL) OR ([OrderDate] = @Original_OrderDate)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [orders] ([InvoiceID], [CustomerID], [Project], [Acres], [OrderTotal]"& _ 
                ", [OrderDate]) VALUES (@InvoiceID, @CustomerID, @Project, @Acres, @OrderTotal, @"& _ 
                "OrderDate);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT OrderID, InvoiceID, CustomerID, Project, Acres, OrderTotal, "& _ 
                "OrderDate FROM Orders WHERE (OrderID = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [orders] SET [InvoiceID] = @InvoiceID, [CustomerID] = @CustomerID, [Projec"& _ 
                "t] = @Project, [Acres] = @Acres, [OrderTotal] = @OrderTotal, [OrderDate] = @Orde"& _ 
                "rDate WHERE (([OrderID] = @Original_OrderID) AND ((@IsNull_InvoiceID = 1 AND [In"& _ 
                "voiceID] IS NULL) OR ([InvoiceID] = @Original_InvoiceID)) AND ([CustomerID] = @O"& _ 
                "riginal_CustomerID) AND ((@IsNull_Project = 1 AND [Project] IS NULL) OR ([Projec"& _ 
                "t] = @Original_Project)) AND ((@IsNull_Acres = 1 AND [Acres] IS NULL) OR ([Acres"& _ 
                "] = @Original_Acres)) AND ((@IsNull_OrderTotal = 1 AND [OrderTotal] IS NULL) OR "& _ 
                "([OrderTotal] = @Original_OrderTotal)) AND ((@IsNull_OrderDate = 1 AND [OrderDat"& _ 
                "e] IS NULL) OR ([OrderDate] = @Original_OrderDate)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT OrderID, InvoiceID"& _ 
                ", CustomerID, Project, Acres, OrderTotal, OrderDate FROM Orders WHERE (OrderID ="& _ 
                " @OrderID)"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DataSet2.OrdersDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As DataSet2.OrdersDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DataSet2.OrdersDataTable = New DataSet2.OrdersDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As DataSet2.OrdersDataTable) As Integer
